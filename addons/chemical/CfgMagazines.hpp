class cfgMagazines
{
    ...
    class RAT_1Rnd_82mm_Mo_Type0: ACE_1Rnd_82mm_Mo_HE
    {
        author="DiGii";
    ...
    class RAT_5Rnd_82mm_Mo_Type0_AI: RAT_1Rnd_82mm_Mo_Type0
    {
        scope = 1;
        count = 5;
    };
    class RAT_1Rnd_82mm_Mo_TypeCS: ACE_1Rnd_82mm_Mo_HE 
    {
        author="DiGii";
    ...
    class RAT_3Rnd_82mm_Mo_TypeCS_AI: RAT_1Rnd_82mm_Mo_TypeCS 
    {
        scope = 1;
        count = 3;
    };
    ...
    class RAT_Gas_TripWireMine_Mag: APERSTripMine_Wire_Mag {
        author = "DiGii";
    ...
    class RAT_CAS_M43_Mag: PylonMissile_Bomb_GBU12_x1 {

        ammo = "RAT_CAS_M43_Ammo";
        author = "DiGii";
        count = 1;
        initSpeed = 0;
        ...
        mass = 100;
        pylonWeapon = "RAT_CAS_M43_Bomb";
    };

    class RAT_CAS_M43_Mag_x2 : PylonRack_Bomb_GBU12_x2 
    {
        ammo = "RAT_CAS_M43_Ammo";
        author = "DiGii";
        count = 2;
    ...
    class RAT_CAS_R_80mm_GAS_MAG: PylonRack_19Rnd_Rocket_Skyfire {
        ammo = "RAT_CAS_R_80mm_GAS_AMMO";
        author = "DiGii";
        ...
        pylonWeapon = "RAT_CAS_R_80mm_GAS_POD";
