class cfgAmmo
{
    ...
    class RAT_SmokeShellArty: SmokeShellArty{
        smokeColor[] = {0,0,0,0};
    };
    ...
    class Sh_82mm_AMOS_Type0: Smoke_82mm_AMOS_White 
    {
        ...
        whistleDist = 20;
        whistleOnFire = 2;
        submunitionAmmo = "RAT_SmokeShellArty";
    };
    ...
    class RAT_Gas_TripWireMine_Ammo: APERSTripMine_Wire_Ammo {
        SoundSetExplosion[] = {};
        defaultMagazine = "RAT_Gas_TripWireMine_Mag"; //Mag that gets dropped after defuse
        hit = 0;
        indirectHit = 0;
        indirectHitRange = 0;
        soundHit[] = {"A3\Sounds_F\weapons\smokeshell\smoke_3",1.25893,1,100};
        explosionEffects = "RAT_GASTripEffect"; 
        CraterEffects = "";
        soundTrigger[] = {"",1,1};
    ...
    class RAT_GASTrip_SmokeEffect: SmokeShell {
        triggerTime = 0.1;
    ...
    class RAT_CAS_M43_Ammo: BombCluster_01_Ammo_F {
        ...
        submunitionAmmo="RAT_CAS_M43_Ammo_sub";
        class CamShakeExplode
        {
            power = 20;
            duration = 2;
    ...
    class RAT_CAS_M43_Ammo_sub: Mo_cluster_Bomb_01_F {
        hit = 0;
        indirectHit = 0;
        indirectHitRange = 0;
        explosionEffects = "RAT_GAS_ClusterExplosion"; 
    };

    class R_80mm_HE;
    class RAT_CAS_R_80mm_GAS_AMMO: R_80mm_HE {
        hit = 0;
        indirectHit = 0;
        indirectHitRange = 0;
        explosionEffects = "RAT_CAS_R_HYDRA_Explosion"; //HERocketExplosion
    };
};