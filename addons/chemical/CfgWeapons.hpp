class CfgWeapons {
    ...
    class rat_gasmaskFilter : ACE_ItemCore {
        scope = 2;
        author = "DiGii";
    ...
    class rat_sealant : ACE_ItemCore {
        scope = 2;
        author = "DiGii";
    ...
    class mortar_82mm: CannonCore {
        magazines[] += {
            "RAT_1Rnd_82mm_Mo_Type0",
            "RAT_5Rnd_82mm_Mo_Type0_AI",
            "RAT_1Rnd_82mm_Mo_TypeCS",
            "RAT_3Rnd_82mm_Mo_TypeCS_AI"
        };
    };
    ...
    class Put: Default {
        ...
        class ace_explosives_muzzle: PutMuzzle {
            magazines[] += {
                "RAT_Gas_TripWireMine_Mag"
            };
        };
    };

    class weapon_GBU12Launcher;
    class RAT_CAS_M43_Bomb: weapon_GBU12Launcher {
        author = "DiGii";
        canLock = 2;
        scope=2;
        ...
        minRange = 150;
        minRangeProbab = 0.6;
        magazines[] = {"RAT_CAS_M43_Mag","RAT_CAS_M43_Mag_x2"};
    ...
    class RAT_CAS_R_80mm_GAS_POD: rockets_Skyfire {
        displayName = "Hydra GAS 19x";
        magazines[] = {"RAT_CAS_R_80mm_GAS_MAG"};
        scope=2;
    };
};
