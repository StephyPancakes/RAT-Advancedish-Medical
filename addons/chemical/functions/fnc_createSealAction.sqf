...
private _action = [
    ...
    "",
    {
        ...
        [
            ...
            [_target,_player],
            {
                ...
                [_target, 0, ["ACE_MainActions", "rat_gas_interaction"]] call ACEFUNC(interact_menu,removeActionFromObject);
                [_player, "rat_sealant"] call ACEFUNC(common,useItem);
            },
            {
                params["_args"];
                _args params ["_target","_player"];
            ...
            {[_player,_player,["rat_sealant"]] call ACEFUNC(medical_treatment,hasItem);},//conditions
            ["isNotInside"]
    ...
    },
    {
        ...
        [_player, _player, ["rat_sealant"]] call ACEFUNC(medical_treatment,hasItem);
    },
    {},
    []
