                ...
                [
                    ...
                    },
                    {
                        ...
                        if (_unit getVariable [QGVAR(airPoisoning),false]) then {
                            ...
                            RAT_PAIN_EFFECT = _effect;
                            _unit setVariable [QGVAR(painEffect), RAT_PAIN_EFFECT, true];
                            RAT_PAIN_EFFECT ppEffectAdjust [0, 0, false];
                            RAT_PAIN_EFFECT ppEffectCommit 0;
                            RAT_PAIN_EFFECT ppEffectEnable true;
                            ...
                            RAT_PAIN_EFFECT ppEffectAdjust _initialAdjust;
                            RAT_PAIN_EFFECT ppEffectCommit 0.3;

                            [{
                                params ["_adjust"];
                                RAT_PAIN_EFFECT ppEffectAdjust _adjust;
                                RAT_PAIN_EFFECT ppEffectCommit 0.7;
