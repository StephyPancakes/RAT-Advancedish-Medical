...
if !(_ammo in RAT_ProjectileCache) exitwith {};

private _configClass = (configFile >> "CfgAmmo" >> _ammo);

private _lifetime = [_configClass, "RAT_lifetime", 60] call BIS_fnc_returnConfigEntry;
private _radius = [_configClass, "RAT_radius", 10] call BIS_fnc_returnConfigEntry;
private _gasLvL = [_configClass, "RAT_toxicLvL", 1] call BIS_fnc_returnConfigEntry;
