...
_h addAction [
  format ["<ui image='x\rat\addons\misc\ui\downarrow.paa' size='1' shadow='false'/> <t>%1</t>", LLSTRING(helistretcher_lower)],
  {
	...
	deleteVehicle _s;
	_s = createVehicle ["rat_stretcher", (_h modelToWorld [0,0,-3])];

	_s addAction [
	  format ["<ui image='x\rat\addons\misc\ui\fliparrow.paa' size='1' shadow='false'/> <t>%1</t>", LLSTRING(helistretcher_flip)],
	  {
		params ["_target", "_caller", "_actionId", "_arguments"];
	...
	[_s,_h,_rope1,_rope2,_rope3,_rope4] call rat_misc_fnc_addActionRaise;
	[_s,_h,_rope1,_rope2,_rope3,_rope4] call rat_misc_fnc_actionLowerBy10;
  },
  [_s,_h],
  1,  // priority
  true,  // showWindow
