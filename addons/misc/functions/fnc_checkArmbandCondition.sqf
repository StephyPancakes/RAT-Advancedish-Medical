...
[_unit, "rat_armband_red_cross"] call ACEFUNC(common,hasItem) || 
[_unit, "rat_armband_medic"] call ACEFUNC(common,hasItem) || 
[_unit, "rat_armband_doctor"] call ACEFUNC(common,hasItem) || 
