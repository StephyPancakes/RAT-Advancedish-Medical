...
_lowerby10 = _h addAction [
  format ["<ui image='x\rat\addons\misc\ui\downarrow.paa' size='1' shadow='false'/> <t>%1</t>", LLSTRING(helistretcher_lower10m)],
  {
...
[
  format ["<ui image='x\rat\addons\misc\ui\uparrow.paa' size='1' shadow='false'/> <t>%1</t>", LLSTRING(helistretcher_raise10m)],
  {
    params ["_target", "_caller", "_actionId", "_arguments"];
    _rope1 = _arguments select 2;
    _rope2 = _arguments select 3;
