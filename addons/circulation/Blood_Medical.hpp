...
class BloodIV_O: BloodIV {
    ...
    items[] = {"rat_bloodIV_O"};
    callbackSuccess = "[_medic, _patient, _bodyPart, _className, _usedItem] call rat_circulation_fnc_handleTreatment; [_patient, 800, 12] call rat_pharma_fnc_fluid;";
};
class BloodIV_O_N: BloodIV {
    displayName = CSTRING(Action_BloodIV_O_N);
    items[] = {"rat_bloodIV_O_N"};
    callbackSuccess = "[_medic, _patient, _bodyPart, _className, _usedItem] call rat_circulation_fnc_handleTreatment; [_patient, 800, 12] call rat_pharma_fnc_fluid;";
};
